package com.example.wufan.baoer_android.register;
...
public interface RegisterContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showError(String errorType);//错误提示

        void showInvitationCode();//显示邀请码的说明
    ...
    interface Presenter extends BasePresenter {
        ...
        void doRegister(String detail);//注册操作

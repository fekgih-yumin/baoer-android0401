package com.example.wufan.baoer_android.main.Bao.baoji;
 ...
 */
public interface BaojiContract {

    interface View extends BaseView<Presenter>{

        void showModleDetail(String modelDetail);//显示型号详情

        void showNoiseList(JSONArray noiseList);//显示噪音列表

        void showNoiseDetail(String modleId);//显示单个噪音的详情
    ...
    interface Presenter extends BasePresenter {
        ...
        String loadModleDetail(String modelId);//加载型号的详情

        JSONArray loadNoiseList();//加载噪音列表

        String loadNoiseDetail(String noiseId);//加载单个噪音的详情

        void loadNoise(String noiseId);//下载噪音

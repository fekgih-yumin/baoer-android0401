 ...
 */
public interface TopTrendSearchContract {

    interface View extends BaseView<Presenter>{

        void showTitleList(String title_list) throws JSONException;//显示主题列表

//        void showTitleDetail(String detail);//点击跳转到album
    }

    interface Presenter extends BasePresenter {


        void getTitleList() throws JSONException;//加载热搜榜的主题

        String getSubjectDetail();//获取主题详情

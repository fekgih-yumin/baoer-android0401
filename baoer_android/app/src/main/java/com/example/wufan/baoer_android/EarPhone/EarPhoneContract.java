package com.example.wufan.baoer_android.EarPhone;
 ...
 */
public interface EarPhoneContract {

    interface View extends BaseView<Presenter>{

        void showEarPhoneList(JSONArray modelList);//显示耳机列表

        void showCreateIllustrate(String illustrate);//显示创建说明

        void writteEarPhoneDetail();//修改耳机信息

    }

    interface Presenter extends BasePresenter {

        JSONArray loadEarPhoneList();//加载耳机列表

        String searchEarPhone(String key);//搜索耳机

        void putEarPhoneDetail(String detail);//修改耳机的信息
    }

package com.example.wufan.baoer_android.talk;
...
public interface TalkContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showRecommend(JSONArray recommendList);//显示推荐

        void showTalkers(JSONArray talkers);//显示所有对话者

    }

    interface Presenter extends BasePresenter {

        JSONArray loadTalk();//加载对话列表

        JSONArray loadRecommend();//加载推荐

        JSONArray searchRecommendKey(String key);//搜索推荐关键词

        void sendRecommend();//发送推荐

        void sendTalk(String content);//发送对话

        JSONArray loadTalkers();//加载所有对话者
    }

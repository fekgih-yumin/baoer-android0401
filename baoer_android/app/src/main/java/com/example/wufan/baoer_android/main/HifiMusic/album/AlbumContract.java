package com.example.wufan.baoer_android.main.HifiMusic.album;
...
public interface AlbumContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showAlbumDetail(String albumContent);//显示专辑或主题的内容

        void showSongList(String songList);//显示歌单
    ...
    interface Presenter extends BasePresenter {
        ...
        String loadAlbum(String musicListId);//加载专辑或主题的详情 *album

        void downloadSong(String songId);//下载歌曲

        void deleteSong(String songId);//删除歌曲

        void playSong();//播放或停止歌曲

        void randomPlaySong();//随机播放

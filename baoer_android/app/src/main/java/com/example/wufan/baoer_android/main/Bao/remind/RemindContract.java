package com.example.wufan.baoer_android.main.Bao.remind;
...
public interface RemindContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showModel(String modelDetail);//显示型号

        void showRemindDetail(String remindDetail);//显示提醒

        void showSettingRemind(String remindDetail);//显示修改提醒页面

    }

    interface Presenter extends BasePresenter {

        String loadCurrentModel(String modelId);//加载当前型号

        void uploadSettingRemind(String remindDetail);//上传修改的提醒设置

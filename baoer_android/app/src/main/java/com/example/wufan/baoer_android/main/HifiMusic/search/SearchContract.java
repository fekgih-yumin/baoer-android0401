...
public interface SearchContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showTabFragment(String list) throws JSONException;//显示搜索结果列表

//        void showHotKey();//显示系统最热前五搜索关键字
...
//        String loadHotKey();//加载系统最热前五搜索关键字

        void SearchKey(String key) throws JSONException;//查找关键词

package com.example.wufan.baoer_android.main.HifiMusic.fm;
...
public interface FmContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showFmList(String list);//显示电台列表
    ...
    interface Presenter extends BasePresenter {
        ...
        String loadFmList();//获取电台列表，menuid: 6,type: "broadcast",contentId: 16

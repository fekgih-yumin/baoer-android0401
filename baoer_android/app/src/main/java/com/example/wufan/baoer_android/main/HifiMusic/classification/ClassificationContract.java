...
public interface ClassificationContract {
    ...
    interface View extends BaseView<Presenter>{
        ...
        void showClassification(String list) throws JSONException;//显示分类

        void showAlbumList(String albumList);//显示专辑列表
    ...
    interface Presenter extends BasePresenter {
        ...
        void loadClassification();//加载分类

        void loadAlbumList(String id);//加载专辑列表
